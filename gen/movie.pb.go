...
type GetMovieDetailsReposne struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetMovieDetailsReposne) Reset() {
	*x = GetMovieDetailsReposne{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetMovieDetailsReposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMovieDetailsReposne) ProtoMessage() {}

func (x *GetMovieDetailsReposne) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMovieDetailsReposne.ProtoReflect.Descriptor instead.
func (*GetMovieDetailsReposne) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{11}
}

func (x *GetMovieDetailsReposne) GetMovieDetails() *MovieDetails {
	if x != nil {
...
var file_movie_proto_rawDesc = []byte{
	...
	0x6f, 0x76, 0x69, 0x65, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76,
	0x69, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x6e, 0x65,
	...
	0x61, 0x69, 0x6c, 0x73, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x95, 0x01, 0x0a, 0x0d, 0x52, 0x61, 0x74, 0x69,
	0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x50, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x50,
	...
	0x7b, 0x0a, 0x0c, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x43, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x12, 0x17, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x44, 0x65, 0x74,
	0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x47, 0x65,
	0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x70,
	0x6f, 0x73, 0x6e, 0x65, 0x12, 0x26, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x0d, 0x2e,
...
var file_movie_proto_goTypes = []interface{}{
	...
	(*GetMovieDetailsReposne)(nil),      // 11: GetMovieDetailsReposne
	(*HelloRequest)(nil),                // 12: HelloRequest
	(*HelloResponse)(nil),               // 13: HelloResponse
}
var file_movie_proto_depIdxs = []int32{
	...
	1,  // 3: GetMovieDetailsReposne.movie_details:type_name -> MovieDetails
	...
	12, // 9: MovieService.Hello:input_type -> HelloRequest
	...
	11, // 14: MovieService.GetMovieDetails:output_type -> GetMovieDetailsReposne
	13, // 15: MovieService.Hello:output_type -> HelloResponse
...
func file_movie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_movie_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetMovieDetailsReposne); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
